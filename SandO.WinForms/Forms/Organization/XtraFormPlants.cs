...
{
    public partial class XtraFormPlants : XtraForm
    {
        public XtraFormPlants()
        {
            InitializeComponent();
        }
        ...
        Plant GetGridViewFocusedObject()
        {
            Plant focusedRow = gridViewMain.GetFocusedRow() as Plant;
            return focusedRow;
        }

        private void barButtonItemNew_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            XtraFormPlant form = new XtraFormPlant();
            form.ShowDialog();
            ...
            ribbonControl.SetMessage(form.ProgressResult.Message, form.ProgressResult.Result ? MessageType.Information : MessageType.Error);
        }

        private void barButtonItemUpdate_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            Plant focusedObject = GetGridViewFocusedObject();
            ...
            XtraFormPlant form = new XtraFormPlant(focusedObject.Id, FormOpenOption.Update);
            form.ShowDialog();
        ...
        private void barButtonItemView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            XtraFormPlant form = new XtraFormPlant(focusedObject.Id, FormOpenOption.View);
            form.ShowDialog();
        }
        ...
        private void barButtonItemDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (XtraMessageBox.Show($"Seçili üretim yerini silmek istediğinize emin misiniz?\nÜretim Yeri Adı: {focusedObject.Name}", "Üretim Yeri Sil", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
            {
                return;
            }
            ...
            ProgressResult progressResult = companyManager.DeletePlant(focusedObject.Id);
            WaitFormMain.CloseWaitForm();
        ...
        {
            CompanyManager companyManager = new CompanyManager();
            QueryResult<List<Plant>> companies = companyManager.GetPlants();
            if (companies.Result)
            {
                gridControlMain.DataSource = companies.ResultObject;
            }
            else
            {
                XtraMessageBox.Show(companies.Message, "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
