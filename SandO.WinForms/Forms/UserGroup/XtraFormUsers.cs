...
{
    public partial class XtraFormUsers : XtraForm
    {
        ...
        UserView GetGridViewFocusedObject()
        {
            UserView focusedRow = gridViewMain.GetFocusedRow() as UserView;
            return focusedRow;
        }

        private void barButtonItemNew_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            XtraFormUser form = new XtraFormUser();
            form.ShowDialog();
        ...
        {
            UserView focusedObject = GetGridViewFocusedObject();
            ...
            XtraFormUser form = new XtraFormUser(focusedObject.Id, FormOpenOption.Update);
            form.ShowDialog();
        ...
        private void barButtonItemView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            XtraFormUser form = new XtraFormUser(focusedObject.Id, FormOpenOption.View);
            form.ShowDialog();
        }
        ...
        private void GetObjects()
        {
            ...
            QueryResult<List<UserView>> queryResult = userGroupManager.GetUsers();
