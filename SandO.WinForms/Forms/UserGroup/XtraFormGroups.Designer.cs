...
namespace SandO.WinForms.Forms.UserGroup
{
    partial class XtraFormGroups
    {
        ...
        private void InitializeComponent()
        {
            ...
            colDesc = new DevExpress.XtraGrid.Columns.GridColumn();
            colDisabledAllPermissions = new DevExpress.XtraGrid.Columns.GridColumn();
            colGuid = new DevExpress.XtraGrid.Columns.GridColumn();
            colModuleDesc = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            // bindingSource
            // 
            bindingSource.DataSource = typeof(Group);
            // 
            // gridViewMain
            // 
            gridViewMain.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] { colName, colDesc, colDisabledAllPermissions, colGuid, colModuleDesc });
            ...
            // colDesc
            // 
            colDesc.FieldName = "Desc";
            colDesc.Name = "colDesc";
            colDesc.Visible = true;
            colDesc.VisibleIndex = 1;
            // 
            // colDisabledAllPermissions
            // 
            colDisabledAllPermissions.FieldName = "DisabledAllPermissions";
            colDisabledAllPermissions.Name = "colDisabledAllPermissions";
            colDisabledAllPermissions.Visible = true;
            colDisabledAllPermissions.VisibleIndex = 2;
            // 
            // colGuid
            // 
            ...
            // colModuleDesc
            // 
            colModuleDesc.FieldName = "ModuleDesc";
            colModuleDesc.Name = "colModuleDesc";
            colModuleDesc.OptionsColumn.ReadOnly = true;
            colModuleDesc.Visible = true;
            colModuleDesc.VisibleIndex = 4;
            // 
            // XtraFormGroups
            // 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colDisabledAllPermissions;
