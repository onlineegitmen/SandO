namespace SandO.WinForms.Templates
{
    partial class XtraFormTemps
    {
        ...
        private void InitializeComponent()
        {
            ...
            // bindingSource
            // 
            bindingSource.DataSource = typeof(TempClass);
            // 
            // gridViewMain
            // 
            gridViewMain.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] { colId, colName, colDescription, colCreatedAt, colUpdatedAt, colIsActive, colIsDeleted, colCreatedBy, colUpdatedBy });
