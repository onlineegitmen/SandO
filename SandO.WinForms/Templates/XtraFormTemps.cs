...
{
    public partial class XtraFormTemps : XtraForm
    {
        public XtraFormTemps()
        {
            InitializeComponent();
        }
        ...
        TempClass GetGridViewFocusedObject()
        {
            TempClass focusedRow = gridViewMain.GetFocusedRow() as TempClass;
            return focusedRow;
        }

        private void barButtonItemNew_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            XtraFormTemp form = new XtraFormTemp();
            form.ShowDialog();
        ...
        {
            TempClass focusedObject = GetGridViewFocusedObject();
            ...
            XtraFormTemp form = new XtraFormTemp(focusedObject.Id, FormOpenOption.Update);
            form.ShowDialog();
        ...
        private void barButtonItemView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            XtraFormTemp form = new XtraFormTemp(focusedObject.Id, FormOpenOption.View);
            form.ShowDialog();
        }
        ...
        {
            List<TempClass> objects = TempClass.GetRandomValues(listCount: 100);
